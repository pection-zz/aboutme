...
if __name__ == "__main__":
	...
	help="Number_language,E,N,T",default="C:\Code_python\image_another\ImageFullVer\\5Test")
	ap.add_argument("-o","--output", required=False,
	help="Path for output image.",default="C:\Code_python\image_another\Binarry+Seg\\5_Test")
