...
img_blue =filter_colors(img,datacolor_blue)

img_pink_shape= detec_color(img_pink,"_pink")
...
# appendfunc(x_point,y_point,x,y)
print (x_point)
print (y_point)

img_yellow_shape = detec_color(img_yellow,"_yellow")
# allshape = img_pink_shape + img_green_shape + img_red_shape + img_yellow_shape + img_blue_shape
allshape = detec_color(img,"poimt")
