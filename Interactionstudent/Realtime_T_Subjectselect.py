...
class MAINWINDOW(object):
    ...
    def setupUi(self, RealTimeSystem):
        ...
        self.bg.setGeometry(QtCore.QRect(0, 0, 240, 475))
        self.bg.setText(_fromUtf8(""))
        self.bg.setPixmap(QtGui.QPixmap(_fromUtf8("teacherBackground")))
        self.bg.setObjectName(_fromUtf8("bg"))
        #RealTimeSystem.setStyleSheet("background-color: lightgreen;")
        ...
        self.la.setText("Subject")
        self.la.setStyleSheet("color: white;font-size: 15pt")
        ...
        self.FRA141.setStyleSheet("background-color: green;color: white;font-size: 11pt;border: white")
        self.FRA142.setStyleSheet("background-color: green;color: white;font-size: 11pt;border: white")
        self.FRA162.setStyleSheet("background-color: green;color: white;font-size: 11pt;border: white")
        self.FRA221.setStyleSheet("background-color: green;color: white;font-size: 11pt;border: white")
        self.FRA241.setStyleSheet("background-color: green;color: white;font-size: 11pt;border: white")
        self.FRA351.setStyleSheet("background-color: green;color: white;font-size: 11pt;border: white")
