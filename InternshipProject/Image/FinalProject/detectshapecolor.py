...
def detec_color(image,color):
    ...
    for i in range(len(x_point)):
        cv2.putText(image, str(i) , (x_point[i], y_point[i]), cv2.FONT_HERSHEY_SIMPLEX,0.5, (150,154,153), 2)
...
img = cv2.imread("./../../trackHand/power_left/12.jpg")
...
img_red,img =filter_colors(dilate,datacolor_red)
# cv2.imwrite("gofill.png",img_red)
imgcontour = img_red.copy()
img_red_shape = detec_color(imgcontour,"_red")
...
cv2.imshow("image_contour",imgcontour)
