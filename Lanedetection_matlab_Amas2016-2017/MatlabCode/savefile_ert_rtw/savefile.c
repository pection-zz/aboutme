...
void savefile_initialize(void)
{
  ...
  /* External mode info */
  savefile_M->Sizes.checksums[0] = (1526769415U);
  savefile_M->Sizes.checksums[1] = (520281342U);
  savefile_M->Sizes.checksums[2] = (176836362U);
  savefile_M->Sizes.checksums[3] = (1308738386U);
