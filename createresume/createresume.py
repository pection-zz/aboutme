...
ProjectFourTitle= '• Image Processing Digit Segment & Robotic Controller'
ProjectFourDesc= '- Using machine learning to predict Digit with other font in realtime after that \ncontrol a camera for predict position x-y-z axis to move'
ProjectFiveTitle= '• Lane detection with Rasberrypi for AMAS2017'
ProjectFiveDesc= '- Using matlab to lane detection in AMAS2017 and use matlab to control \nlow-level for drive car and combine a image processing in matlab'
ProjectSixTitle = '• SimulateRobotpickingGripper & find 2D convolution in hand'
ProjectSixDesc= '- Using simulate program for see Robot to picking a Gripper \n- Find joint with image processing from Thermal Camera'
Portfolio = 'Other Projects in : github.com/pection/aboutme'
...
plt.annotate(ProjectOneDesc, (.04,.67), weight='regular', fontsize=8)
plt.annotate(ProjectTwoTitle, (.02,.65), weight='bold', fontsize=10)
plt.annotate(ProjectTwoDesc, (.04,.605), weight='regular', fontsize=8)
plt.annotate(ProjectThreeTitle, (.02,.58), weight='bold', fontsize=10)
plt.annotate(ProjectThreeDesc, (.04,.55), weight='regular', fontsize=8)
plt.annotate(ProjectFourTitle, (.02,.53), weight='bold', fontsize=10)
plt.annotate(ProjectFourDesc, (.04,.50), weight='regular', fontsize=8)
plt.annotate(ProjectFiveTitle, (.02,.48), weight='bold', fontsize=10)
plt.annotate(ProjectFiveDesc, (.04,.45), weight='regular', fontsize=8)
plt.annotate(ProjectSixTitle, (.02,.43), weight='bold', fontsize=10)
plt.annotate(ProjectSixDesc, (.04,.40), weight='regular', fontsize=8)
plt.annotate(Portfolio, (.02,.365), weight='bold', fontsize=12)
plt.annotate(WorkHeader, (.02,.34), weight='bold', fontsize=10, color='#393b44')
plt.annotate(WorkOneTitle, (.02,.32), weight='bold', fontsize=10)
plt.annotate(WorkOneTime, (.02,.30), weight='regular', fontsize=8, alpha=.6)
plt.annotate(WorkOneDesc, (.04,.27), weight='regular', fontsize=8)
plt.annotate(WorkTwoTitle, (.02,.24), weight='bold', fontsize=10)
plt.annotate(WorkTwoTime, (.02,.22), weight='regular', fontsize=8, alpha=.6)
plt.annotate(WorkTwoDesc, (.04,.13), weight='regular', fontsize=8)
...
plt.annotate(EduOneTime, (.02,.02), weight='regular', fontsize=8, alpha=.6)
...
plt.annotate(ExtrasDesc, (.7,.305), weight='regular', fontsize=10, color='#ffffff')
plt.annotate(CodeTitle, (.73,.25), weight='regular', fontsize=10, color='#ffffff')
