...
ProjectTwoTitle= '• XY-Plotter'
ProjectTwoDesc= '- XY Plotter Project for control XY plotter with forward kinematic pid control \nand combine a Image Processing in python to Draw Picture \nin 24FJ48GA002 controller'
ProjectThreeTitle= '• Humanoid Leaguge'
ProjectThreeDesc= '- 3rd place Robocup Asia-Pacific RCAP2017 in Humanoid Leaguges(Kid Size)\n -Learning in Humanoid-lab to 4 years'
ProjectFourTitle= '• ImageProcessingDigitSegment'
...
ProjectSixTitle = '• SimulateRobotpickingGripper & find a joint in Hand'
